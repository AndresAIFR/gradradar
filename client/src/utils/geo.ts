...
// US State centroids for bubble positioning
 ...
 * @returns Full state name or the code if not found
 */
export function getStateName(stateCode: string): string {
  return US_STATE_CENTROIDS[stateCode as keyof typeof US_STATE_CENTROIDS]?.name || stateCode;
}